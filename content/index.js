module.exports = {
  ...
  experiences: [
    ...
    },
    {
      ...
      summary: [
        'Refactored benefits admin dashboard to build employee summaries by crunching data from 3 different services to bring down max load time from 15 seconds to 650ms',
        'Refactored entire volume calculation service to cover incorporate complex business rules and brought down support requests by 80%',
        'Contributed to org wide event sourcing architecture to integrate separate channels for temportal and linear data channels, without disrupting existing services',
        'Acted as devops deputy for my team to deal with infra level blockers'
      ]
    },
    {
      from: "2019-06",
